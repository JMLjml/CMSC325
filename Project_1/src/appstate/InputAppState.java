...
//                   fire();              
    ...
    public void fire(List<Geometry> targets, Node guiNode, BitmapText hitText){
        
        System.out.println("Fire method called");
        
        if(character != null){
            Ray r = new Ray(app.getCamera().getLocation(), app.getCamera().getDirection());
            
            // Check for a collision with a known target
            ...
            if(collRes.size() > 0){
                ...
                // Display the hit message to the GUI               
