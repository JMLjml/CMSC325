...
public class CharacterInputAnimationAppState extends AbstractAppState implements AnalogListener, ActionListener{
    ...
    private String[] mappingNames = new String[]{InputMapping.Wave.name(), InputMapping.SideKick.name(), InputMapping.Fire.name(), InputMapping.LeanFree.name(), InputMapping.LeanLeft.name(), InputMapping.LeanRight.name(),InputMapping.ToggleCover.name(), InputMapping.RotateLeft.name(), InputMapping.RotateRight.name(), InputMapping.LookUp.name(), InputMapping.LookDown.name(), InputMapping.StrafeLeft.name(),
    ...
    private void addInputMappings(){
        ...
        inputManager.addMapping(InputMapping.Wave.name(), new KeyTrigger(KeyInput.KEY_G));
        inputManager.addMapping(InputMapping.SideKick.name(), new KeyTrigger(KeyInput.KEY_RETURN));
